...
<section className="relative mt-20">
  <div className="bg-blue-800 text-white rounded-lg shadow-md overflow-hidden">
    <div className="relative py-6 px-8 flex items-center">
      {/* Decorative Elements */}
      <div className="absolute inset-0 w-full h-full">
        <svg
          ...
          fill="none"
        >
          <circle cx="150" cy="200" r="200" fill="#ffffff33" />
          <circle cx="650" cy="100" r="150" fill="#ffffff22" />
        </svg>
      </div>
      {/* Title */}
      <h1 className="text-4xl font-bold z-10 relative tracking-wide leading-relaxed">
        <span className="border-l-2 border-yellow-400 pl-4">
          Advisory Services
        </span>
      </h1>
    </div>
...
<section className="container text-gray-600 border-2 border-gray-200 rounded-lg p-4 my-3 mx-2">
                <div className="container px-5 py-24 mx-auto flex flex-wrap">
                    <div className="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
                    <div className="w-full sm:p-6 px-6 mb-8 bg-gradient-to-r from-blue-50 via-white to-blue-50 shadow-lg rounded-lg transition-transform transform hover:scale-105">
                    ...
                    <div className="lg:w-1/1  sm:w-1/2 w-full rounded-lg overflow-hidden mt-6 sm:mt-0">
                        <img className="object-cover object-center w-full h-fit" src="https://intentmarketresearch.com/assets/frontend/homepage/images/1.webp" alt="stats" />
                    </div>
                </div>
                <div className="my-3">
                    <p className="text-lg font-medium text-gray-600 dark:text-white">Competitive Intelligence</p>
                </div>
                <div
                    id="accordion-color"
                ...
                >
                    ...
                    <h2 id="accordion-color-heading-1">
                        <button
                            type="button"
                            className={`flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800 gap-3 ${activeIndex === 1
                    ...
                    <h2 id="accordion-color-heading-2">
                        <button
                            type="button"
                            className={`flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800 gap-3 ${activeIndex === 2
                                ? "bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white"
                                : ""
                                }`}
                    ...
                    <h2 id="accordion-color-heading-3">
                        <button
                            type="button"
                            className={`flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-gray-200 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800 gap-3 ${activeIndex === 3
                                ? "bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white"
                                : ""
                                }`}
                ...
                <div className="my-3">
                    ...
                    <div className="flex justify-center items-center">
                        <img src="https://intentmarketresearch.com/assets/frontend/homepage/images/Competitive-Intelligence-Process-1024x1024.jpg" alt="" className="my-3 w-80 h-80" />
                ...
                <div>
                    <p className=" my-3 text-lg font-medium text-gray-600 dark:text-white">Few of our competitive intelligence services include the following:</p>
                    <div
                        id="accordion-color"
                        data-accordion="collapse"
                        data-active-classes="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white"
                    >
                        ...
                        <h2 id="accordion-color-heading-1">
                            ...
                            >
                                ...
                                <svg
                                    data-accordion-icon
                                    className={`w-3 h-3 transform ${activeIndex1 === 1 ? "rotate-180" : ""
                                        } shrink-0`}
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 10 6"
                        ...
                        <h2 id="accordion-color-heading-2">
                            <button
                                ...
                                aria-expanded={activeIndex1 === 2}
                                aria-controls="accordion-color-body-2"
                            >
                                <span>Benchmarketing Metrics</span>
                                <svg
                                    data-accordion-icon
                                    className={`w-3 h-3 transform ${activeIndex1 === 2 ? "rotate-180" : ""
                                        } shrink-0`}
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 10 6"
                        ...
                        <h2 id="accordion-color-heading-3">
                            <button
                                ...
                                aria-expanded={activeIndex1 === 3}
                                aria-controls="accordion-color-body-3"
                            >
                                <span>Competitor Tracking and Monitoring</span>
                                <svg
                                    data-accordion-icon
                                    className={`w-3 h-3 transform ${activeIndex1 === 3 ? "rotate-180" : ""
                                        } shrink-0`}
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 10 6"
                ...
                <div className="my-3">
                    <p className="text-lg font-medium text-gray-600 dark:text-white">Competitive Intelligence</p>
                    <div className="flex justify-center items-center">
                        <img src="https://intentmarketresearch.com/assets/frontend/homepage/images/5.webp" alt="" className="my-5 w-100 h-100" />
                ...
                <div>
                    <p className=" my-3 text-lg font-medium text-gray-600 dark:text-white">Few of the strategic business objectives for which IMR supports business entities:</p>
                    <div
                        id="accordion-color"
                        data-accordion="collapse"
                        data-active-classes="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white"
                    >
                        ...
                        <h2 id="accordion-color-heading-1">
                            ...
                            >
                                ...
                                <svg
                                    data-accordion-icon
                                    className={`w-3 h-3 transform ${activeIndex2 === 1 ? "rotate-180" : ""
                                        } shrink-0`}
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 10 6"
                        ...
                        <h2 id="accordion-color-heading-2">
                            <button
                                ...
                                aria-expanded={activeIndex2 === 2}
                                aria-controls="accordion-color-body-2"
                            >
                                <span>Market Entry Barriers</span>
                                <svg
                                    data-accordion-icon
                                    className={`w-3 h-3 transform ${activeIndex2 === 2 ? "rotate-180" : ""
                                        } shrink-0`}
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 10 6"
                        ...
                        <h2 id="accordion-color-heading-3">
                            <button
                                ...
                                aria-expanded={activeIndex2 === 3}
                                aria-controls="accordion-color-body-3"
                            >
                                <span>Competitor Tracking and Monitoring</span>
                                <svg
                                    data-accordion-icon
                                    className={`w-3 h-3 transform ${activeIndex2 === 3 ? "rotate-180" : ""
                                        } shrink-0`}
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 10 6"
                ...
                <div className="my-3">
                    <p className="text-lg font-medium text-gray-600 dark:text-white">Strategic Alliances and Acquisition Services</p>
                </div>
                <div
                    id="accordion-color"
                    data-accordion="collapse"
                ...
                >
                    ...
                    <h2 id="accordion-color-heading-1">
                        <button
                            ...
                            aria-expanded={activeIndex3 === 1}
                            aria-controls="accordion-color-body-1"
                        >
                            <span>Strategic Alliance</span>
                            <svg
                                data-accordion-icon
                                className={`w-3 h-3 transform ${activeIndex3 === 1 ? "rotate-180" : ""
                                    } shrink-0`}
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 10 6"
                    ...
                    <h2 id="accordion-color-heading-2">
                        <button
                            ...
                            onClick={() => toggleAccordion3(2)}
                            aria-expanded={activeIndex3 === 2}
                            aria-controls="accordion-color-body-2"
                        >
                            <span>Mergers & Acquisitions</span>
                            <svg
                                data-accordion-icon
                                className={`w-3 h-3 transform ${activeIndex3 === 2 ? "rotate-180" : ""
                                    } shrink-0`}
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 10 6"
                    ...
                    <h2 id="accordion-color-heading-3">
                        <button
                            ...
                            onClick={() => toggleAccordion3(3)}
                            aria-expanded={activeIndex3 === 3}
                            aria-controls="accordion-color-body-3"
                        >
                            <span>Synergy Analysis</span>
                            <svg
                                data-accordion-icon
                                className={`w-3 h-3 transform ${activeIndex3 === 3 ? "rotate-180" : ""
                                    } shrink-0`}
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 10 6"
                ...
                <div className="my-3">
                    <p className="text-lg font-medium text-gray-600 dark:text-white">Supply Chain Optimization</p>
                </div>
                <div>
                ...
                >
                    ...
                    <h2 id="accordion-color-heading-1">
                        <button
                            ...
                            aria-expanded={activeIndex4 === 1}
                            aria-controls="accordion-color-body-1"
                        >
                            <span>Supply Chain Overview</span>
                            <svg
                                data-accordion-icon
                                className={`w-3 h-3 transform ${activeIndex4 === 1 ? "rotate-180" : ""
                                    } shrink-0`}
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 10 6"
                    ...
                    <h2 id="accordion-color-heading-2">
                        <button
                            ...
                            onClick={() => toggleAccordion4(2)}
                            aria-expanded={activeIndex4 === 2}
                            aria-controls="accordion-color-body-2"
                        >
                            <span>Logistics Overview</span>
                            <svg
                                data-accordion-icon
                                className={`w-3 h-3 transform ${activeIndex4 === 2 ? "rotate-180" : ""
                                    } shrink-0`}
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 10 6"
                    ...
                    <h2 id="accordion-color-heading-3">
                        <button
                            ...
                            onClick={() => toggleAccordion4(3)}
                            aria-expanded={activeIndex4 === 3}
                            aria-controls="accordion-color-body-3"
                        >
                            <span>Low-Cost Country Sourcing</span>
                            <svg
                                data-accordion-icon
                                className={`w-3 h-3 transform ${activeIndex4 === 3 ? "rotate-180" : ""
                                    } shrink-0`}
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 10 6"
...
<section className="text-gray-600 body-font">
                <div className="container px-5 py-20 mx-auto">
                    <div className="flex flex-col text-center w-full mb-10">
                        <h1 className="sm:text-3xl text-2xl font-bold title-font mb-4 text-gray-900 py-2 bg-blue-400">Releted Reports</h1>
                    </div>
 ...
 <section className="text-gray-700 body-font bg-gradient-to-l from-yellow-50 to-pink-50 py-16">
    ...
    <div className="flex flex-wrap -m-4">
      ...
      {Array(6).fill().map((_, index) => (
        <div key={index} className="p-4 lg:w-1/3 md:w-1/2 w-full">
          <div className="h-full bg-white border border-gray-200 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
            {/* Case Study Content */}
            <div className="p-6 relative">
              <h2 className="text-lg font-semibold text-gray-800 mb-4 hover:text-pink-500 transition-all duration-300">
              ...
              <div className="absolute inset-0 bg-pink-500 bg-opacity-20 opacity-0 hover:opacity-100 transition-opacity duration-300 rounded-lg">
                <div className="flex justify-center items-center h-full">
                  <p className="text-white text-lg font-semibold">Read Full Case Study</p>
                </div>
              </div>
            </div>
          </div>
...
<section className="text-gray-600 body-font bg-gradient-to-r from-white-200 to-skyblue-200 py-16">
  <div className="container px-6 py-8 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      <h1 className="sm:text-3xl text-2xl font-extrabold text-indigo-900 tracking-widest uppercase mb-4">Related Thought Leadership</h1>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
      {/* Card 1 */}
      <div className="relative bg-white p-6 rounded-lg shadow-xl transform hover:scale-105 transition-all duration-300 ease-in-out">
        <div className="absolute inset-0 bg-cover bg-center rounded-lg opacity-30" style={{ backgroundImage: 'url("https://png.pngtree.com/thumb_back/fh260/background/20240102/pngtree-vibrant-splash-of-blue-cyan-an-abstract-painting-with-watercolor-texture-image_13898402.png")' }}></div>
      ...
      <div className="relative bg-white p-6 rounded-lg shadow-xl transform hover:scale-105 transition-all duration-300 ease-in-out">
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-700 mb-4">
            A closer look at AI-powered predictive maintenance and how it's shaping the future of various industries.
          </p>
          <p className="text-sm text-gray-600">Published Date: Nov 2024</p>
        </div>
      </div>
