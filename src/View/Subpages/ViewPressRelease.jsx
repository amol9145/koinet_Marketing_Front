                            ...
                            <div className="bg-blue-100 text-black rounded-lg p-6 transition duration-200 hover:shadow-xl shadow-lg">
                                ...
                                <form className="space-y-4" ref={form} onSubmit={handleSendEmail}>
                                    ...
                                    <div className="text-center">
                                        <button type="submit" disabled={loading} className=" mt-3 relative inline-flex  ms-5  items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-pink-500 to-orange-400 group-hover:from-pink-500 group-hover:to-orange-400  focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800">
